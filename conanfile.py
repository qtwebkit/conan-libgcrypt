...
class LibgcryptConan(ConanFile):
    ...
    version = "1.7.3"
    branch = "master"
    ZIP_FOLDER_NAME = "libgcrypt-%s" % version
    generators = "cmake"
    ...
    requires = 'libgpg-error/1.24@DEGoodmanWilson/testing'
    ...
    def source(self):
        zip_name = "libgcrypt-%s.tar.gz" % self.version
        download("https://gnupg.org/ftp/gcrypt/libgcrypt/%s" % zip_name, zip_name)
